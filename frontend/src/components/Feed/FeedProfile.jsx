        ...
        <div className="border rounded-lg overflow-hidden shadow-md text-center bg-white">
            <div className="relative">
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
                    <img className="rounded-full w-16 profile -mb-8" src="https://codescandy.com/geeks-bootstrap-5/assets/images/avatar/avatar-4.jpg" alt="" />
                </div>
            </div>
            ...
            <div className="py-8 mt-2">
                <div className="border-b px-4 py-2">
                    ...
                    <div className="email mt-2">
                        <span className="text-gray-600">rudra@gmail.com</span>
                    </div>
                </div>
