...
function SignupForm() {
    ...
    const submitHandler = (e) => {
        ...
        // Set the accountType property in formData
    ...
    return (
        <div className='login-content flex items-center justify-center text-center h-full'>
            <form className='text-center items-center flex flex-col gap-6' onSubmit={submitHandler}>
                ...
                <InputField Icon={FaUser} type='email' name='email' ph='Email' data={formData.email} event={changeHandler} />
